...
class SearchParams {
 public:
  ...
  bool GetMctsTreeStats() const { return options_.Get<bool>(kMctsTreeStatsId); }
  bool GetVerboseStatsEveryNode() const {
    return options_.Get<bool>(kVerboseStatsEveryNodeId);
  }
  ...
  static const OptionId kVerboseStatsEveryNodeId;
